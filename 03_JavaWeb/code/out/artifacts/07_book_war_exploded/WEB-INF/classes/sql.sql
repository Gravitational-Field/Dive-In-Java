...
##插入初始数据
insert  into `t_user`(`id`,`username`,`password`,`email`) values (1,'root','123456','123@q.com'),(2,'admin','123456','234@q.c'),(3,'keen','123456','234@s.q'),(5,'xinru','123456','12@qw.q'),(6,'xinru12','123456','123@2.com'),(7,'keen1','123456','sa@q.c'),(8,'keen2','123456','sa@q.c'),(9,'keen3','123456','sa@q.c'),(10,'keen4','123456','li1316@163.com');

## 查询表
select * from t_user;

# 测试某些项
SELECT id,username,PASSWORD,email FROM t_user WHERE username = 'root';

SELECT id,username,PASSWORD,email FROM t_user WHERE username = 'root' AND PASSWORD = '123456';

INSERT INTO t_user(username,PASSWORD,email) VALUES('admin','123456','234@q.c');
